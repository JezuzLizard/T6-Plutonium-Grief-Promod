...
init_wallbuys()
{
	scripts\zm\_gametype_setup::wallbuy( "rottweil72_zm", "olympia", "weapon_upgrade", ( 10559, 8220, -495 ), ( 0, 90, 0) );
	scripts\zm\_gametype_setup::wallbuy( "mp5k_zm", "mp5", "weapon_upgrade", ( 10678, 8135, -476 ), ( 0, 180, 0 ) );
